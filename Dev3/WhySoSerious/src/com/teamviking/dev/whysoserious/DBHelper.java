...
/**
 * DBHelper class Phase 1 
 * This class is used the create / modify the DB
 * 
...
public class DBHelper extends SQLiteOpenHelper {
	...
	/**
	 * onCreate Method
	 * Creates Joke and Category Table.
	 * 
	...
	/**
	 * insertNewJoke Method
	 * Inserts a new joke into the Db
	 * 
	 * @param String category
	 * @param String subCategory
	 * @param int jokeTypeCode
	 * @param String jokeShortDescription
	 * @param String questionText
	 * @param String answerText
	 * @param String monologueText
	 * @param int ratingScale
	 * @param String comments
	 * @param String jokeSource
	...
	/**
	 * getJokeById Method
	 * returns a Cursor of database record that matches the id
	 * 
	 * @param int id
	 * @return Cursor
	 * @throws
	...
	/**
	 * getRandomJoke Method
	 * returns a cursor of a random joke in the database
	 * 
	...
	/**
	 * getFiveRandomJokes Method
	 * returns a cursor of five random jokes in the database
	 * 
	 * @param String[] categories
	 * @return Cursor
	 * @throws
	...
	/**
	 * getFirstJokeDate Method
	 * Returns the date of the first joke to be inserted
	 * into the database
	 * 
	 * @param
	 * @return String
	...
	/**
	 * getLastJokeDate Method
	 * Returns the date of the last joke to be inserted
	 * into the database
	 * 
	 * @param
	 * @return String
	...
	/**
	 * getNumberOfCategoryJokesInDatabase Method
	 * Returns how many jokes are in the category
	 * 
	 * @param String category
	 * @return Integer
	 * @throws
	...
	/**
	 * getNumberOfJokesInDatabase Method
	 * Returns how many jokes are in the database
	 * 
	 * @param 
	 * @return Integer
	 * @throws
